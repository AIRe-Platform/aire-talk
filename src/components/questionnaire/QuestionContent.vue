...
import { AireContent, AireQuestionOptionContent } from 'aire';
...
const answer = ref(props.answer as number || props.options || null);
...
console.log("what is this", props.message, props.options);
</script>

<template>
    <div class="questionnaire-answer">
        <div class="questionnaire-answer-options">
            <div v-for="content in props.options || []" :key="content.id">
                <ChatContent :content="content" :contentId="content.id ?? ''" />
            </div>
        </div>
