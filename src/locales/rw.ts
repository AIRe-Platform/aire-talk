...
const rw: Locale = {
    ...
    tooltip_accept_summary: "I accept summary this summary.",
    ...
    tooltip_nav_menu_home: "description home",
    tooltip_nav_menu_chat: "description chat",
    tooltip_nav_menu_chat_history: "description chat history",
    tooltip_nav_menu_new_chat: "description chat new",
    tooltip_nav_menu_content_catalogue: "description content catalogue",
    tooltip_nav_menu_profile: "description profile",
    tooltip_nav_menu_log_in: "description login",
    tooltip_nav_menu_log_out: "description logout",
    tooltip_nav_menu_sign_up: "description signup",
    tooltip_nav_menu_settings: "description preferences",
    tooltip_nav_menu_main_menu: "description main menu",
    tooltip_nav_menu_catalogue: "description catalogue",
    tooltip_nav_menu_about: "description about",
